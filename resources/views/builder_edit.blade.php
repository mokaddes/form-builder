                    ...
                    <div class="card-header">
                        <div class="my-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="form_name" value="{{ $form->name }}" name="form_name" placeholder="Enter form name">
                            </div>
                        </div>
                    </div>
...
@push('script')
    ...
    <script>
        jQuery($ => {
            let jsonContent = @json($form->json_content);
            const fbEditor = document.getElementById("build-wrap"), options = {
                dataType: 'json',
